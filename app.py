...
if "DB_HOST" in os.environ:
    ...
    host = "omniscdb.f8ahcnbhemb5hdfm.westeurope.azurecontainer.io"
...
def db_connect():
    ...
    try:
        ...
        connection = pymapd.connect(
            user=user, password=password, host="omniscdb.f8ahcnbhemb5hdfm.westeurope.azurecontainer.io", dbname=db_name
        )
